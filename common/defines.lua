...
military = {
	...
	BASE_CHANCE_TO_AVOID_HIT = 40.0,	-- Base chance to avoid hit if defences left.
	...
	BRIGADES_IN_DIVISION = 9,	--number of allowed brigades in a division.
	...
	BOMB_SHIP_DAMAGE_MODIFIER = 3.05, -- bombing ships
	BOMB_WING_DAMAGE_MODIFIER = 1050, -- bombing airplanes (on ground)
	...
	LAND_COMBAT_ORG_ARMOR_ON_SOFT_DICE_SIZE = 4.5,
	LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.9,
	LAND_COMBAT_ORG_DAMAGE_MODIFIER = 8.2,
	...
	NAVAL_RANK_3 = 18,
	NAVAL_RANK_4 = 30,
	RADIO_CORPS_LEADER_DISTANCE = 300,
	RADIO_ARMY_LEADER_DISTANCE = 900,
	RADIO_ARMYGROUP_LEADER_DISTANCE = 1000,
	RADIO_THEATHRE_LEADER_DISTANCE = 1500,
